...
created: 2026-07-18
updated: 2026-07-18
sources: [2026-07-18-light-theme-polish-phase1.md]
...
social-platform (Instagram/Facebook) colors.
...
## Rollout
Phase 1 (shipped): the shared kit + adoption across the 3 dashboards, campaigns (builder + list/details/
marketplace), browse + the full-page-gray/off-brand-button quick wins. Phase 2/3: messaging (the
`bg-teal-50` island), the DragonShare pair, settings, org/billing, promotions, outstand, public profiles.
