...
const CreatorEarnings: React.FC = () => {
  ...
  return (
    <DashboardLayout userRole="content_creator">
      <div className="min-h-screen overflow-x-hidden w-full max-w-full md:max-w-3xl md:mx-auto">
        ...
        <div className="bg-white px-4 pt-4 pb-24 md:pb-0 space-y-4 overflow-hidden">
          ...
          <div className="grid grid-cols-3 divide-x divide-dc-pink border-2 border-dc-teal rounded-2xl overflow-hidden">
            <div className="p-2 sm:p-3 text-center min-w-0 overflow-hidden">
              ...
              <p className="text-[10px] sm:text-xs text-gray-500 leading-tight">Stripe Bal.</p>
            </div>
            <div className="p-2 sm:p-3 text-center min-w-0 overflow-hidden">
              {isLoadingStatus ? (
                <Skeleton className="h-6 w-14 mx-auto mb-1" />
              ) : (
                <p className={`text-sm sm:text-base font-extrabold truncate ${canWithdraw ? 'text-green-600' : 'text-amber-600'}`}>
                  {formatCurrency(payoutStatus?.platformPendingBalance || 0)}
                </p>
              )}
              <p className="text-[10px] sm:text-xs text-gray-500 leading-tight">Wallet</p>
            </div>
            <div className="p-2 sm:p-3 text-center min-w-0 overflow-hidden">
              {isLoadingEarnings ? (
                <Skeleton className="h-6 w-14 mx-auto mb-1" />
