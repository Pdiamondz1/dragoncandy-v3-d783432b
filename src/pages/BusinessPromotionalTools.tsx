...
import { QrCode, Video, Ticket } from 'lucide-react';
import { usePromotions } from '@/hooks/usePromotions';

const BusinessPromotionalTools: React.FC = () => {
  const { pendingSubmissions } = usePromotions();
        ...
        <Tabs defaultValue="promotions" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 lg:w-auto lg:inline-grid">
            <TabsTrigger value="promotions" className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline">Active Promotions</span>
            ...
            <TabsTrigger value="codes" className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline">Verify Codes</span>
