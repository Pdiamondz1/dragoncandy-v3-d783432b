    ...
    <div className="space-y-4">
      ...
      <div className="bg-teal-50 border border-teal-200 rounded-xl p-3.5">
        <div className="flex items-center gap-2 mb-2.5">
          ...
          <div>
            <p className="text-[13px] font-semibold text-dc-text">{formatScheduledTime(scheduledAt)}</p>
        ...
        <p className="text-[10px] text-dc-text-muted mb-2.5">{fileCount} file{fileCount !== 1 ? 's' : ''}</p>
      ...
      <div className="space-y-2">
        <button
          ...
          onClick={() => {
            onDone();
            navigate(`/calendar?date=${encodeURIComponent(scheduledAt)}`);
          }}
