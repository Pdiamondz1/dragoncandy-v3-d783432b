...
export function AmplificationPreview({ creatorId, orgId, creatorName, orgName }: AmplificationPreviewProps) {
  ...
  return (
    <div className="bg-dc-teal/5 border border-dc-teal/20 rounded-xl p-3">
      <p className="text-[11px] font-bold text-teal-700 uppercase tracking-wider mb-2">
        🚀 Boost Reach Preview
      </p>
      <div className="flex flex-wrap gap-1.5 mb-2">
        {platforms.map((p, i) => (
          <span
            ...
            className="inline-flex items-center gap-1 bg-white border border-gray-200 px-2.5 py-1 rounded-full text-[11px] text-dc-text font-medium"
          >
      ...
      <p className="text-xs text-dc-text-muted">
        Reaches <strong className="text-teal-700">{platforms.length} channels</strong> across{' '}
