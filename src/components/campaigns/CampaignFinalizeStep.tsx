      ...
      <Card className="mb-6 border-primary/20 bg-gradient-to-br from-primary/5 to-pink-500/5">
        <CardContent className="pt-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="p-3 rounded-lg bg-white/70 min-w-0">
          ...
          <Card>
            <CardContent className="pt-6 space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-3 p-4 border border-dc-teal/15 rounded-lg bg-dc-teal/[0.04]">
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3 p-4 border border-dc-teal/15 rounded-lg bg-dc-teal/[0.04]">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex items-center gap-2">
                          <svg className="h-4 w-4 text-dc-pink-accent" fill="currentColor" viewBox="0 0 20 20">
                          ...
                          <FormLabel className="text-sm font-semibold cursor-pointer text-dc-text">
                      ...
                      <div className="ml-7">
                        {field.value ? (
                          <div className="flex items-center gap-2 text-sm text-dc-teal-btn">
              ...
              <Button
                ...
                className={`flex items-center gap-2 ${
                  ...
                  form.watch('publishImmediately')
                    ...
                    : 'bg-dc-teal/10 hover:bg-dc-teal/15 text-dc-teal-btn'
                }`}
              >
                {isCreating ? (
                  'Creating…'
