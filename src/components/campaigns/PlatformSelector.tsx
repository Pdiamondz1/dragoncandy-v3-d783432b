      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <button
            ...
            className="flex h-10 w-full items-center justify-between rounded-md border border-dc-teal/20 bg-white px-3 py-2 text-sm text-gray-700 hover:border-dc-teal/40 focus:border-dc-teal focus:outline-none focus:ring-1 focus:ring-dc-teal"
          >
          ...
          {isDropdownOpen && availableOptions.length > 0 && (
            <div className="absolute z-50 mt-1 w-full rounded-md border border-dc-teal/15 bg-white shadow-lg">
              <div className="max-h-60 overflow-auto py-1">
                {availableOptions.map((platform) => (
                  <button
                    ...
                    className="w-full px-3 py-2 text-left text-sm text-gray-700 hover:bg-dc-teal/5 focus:bg-dc-teal/5 focus:outline-none"
                  >
                    {platform}
                  </button>
                ))}
