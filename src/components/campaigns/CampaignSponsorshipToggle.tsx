...
export const CampaignSponsorshipToggle: React.FC<CampaignSponsorshipToggleProps> = ({
  ...
  return (
    <Card className="border-dc-teal/15 bg-dc-teal/[0.04]">
      <CardHeader>
        <CardTitle className="text-lg flex items-center gap-2">
          <svg className="h-5 w-5 text-dc-pink-accent" fill="currentColor" viewBox="0 0 20 20">
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between space-x-4">
          <div className="flex items-center gap-2 flex-1">
            <Label htmlFor="sponsorship-toggle" className="text-sm font-medium text-dc-text">
              Open for brand sponsorships
            </Label>
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <HelpCircle className="h-4 w-4 text-dc-teal-btn cursor-help" />
                </TooltipTrigger>
        ...
        {openForSponsorship ? (
          <div className="flex items-start gap-2 text-sm text-dc-teal-btn bg-dc-teal/10 p-3 rounded-lg">
          ...
          <div className="flex items-start gap-2 text-sm text-muted-foreground bg-dc-teal/[0.04] p-3 rounded-lg">
            <svg className="h-4 w-4 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
