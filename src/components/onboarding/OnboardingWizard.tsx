...
export function OnboardingWizard() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-gray-50 via-white to-teal-50/30 text-dc-text flex items-center justify-center">
      <div className="w-full md:max-w-lg md:bg-white md:border md:border-dc-text/10 md:rounded-3xl md:shadow-card-elevated md:my-8">
          ...
          >
            {!isFirstInput ? (
              <motion.button
                ...
                onClick={goBack}
                whileTap={{ scale: 0.9 }}
                className="w-10 h-10 rounded-full bg-dc-text/5 flex items-center justify-center text-dc-text-muted hover:bg-dc-text/10 transition-colors"
              >
          ...
          <div className="text-center mb-5">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-sm text-dc-text-muted/70 mt-0.5">{stepSubtitle()}</p>
              </motion.div>
            </AnimatePresence>
          </div>
        )}
        ...
        {currentStep === 'identity' && (
          <div className="text-center mb-5">
            ...
            >
              ...
              <p className="text-sm text-dc-text-muted/70 mt-0.5">
          ...
          >
            <Button
              ...
              className={`w-full rounded-full py-6 text-base font-bold transition-all duration-200 ${
                accentColor === 'teal'
                  ? 'bg-dc-teal-btn hover:bg-dc-teal-btn-hover text-white disabled:bg-dc-text/10 disabled:text-dc-text-muted/70'
                  : 'bg-dc-pink-accent-btn hover:bg-dc-pink-accent-btn-hover text-white disabled:bg-dc-text/10 disabled:text-dc-text-muted/70'
              }`}
            >
            ...
            <p className="text-center text-xs text-dc-text-muted/70 mt-3">
