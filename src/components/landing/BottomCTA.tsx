...
export const BottomCTA = () => {
  ...
  return (
    <div className="text-center mt-24 bg-white rounded-3xl p-16 shadow-2xl border-2 border-dc-teal hover:shadow-3xl transition-all duration-500">
      <h2 className="text-4xl font-bold text-[#111111] mb-6">
        Complete Content Creation Platform
      </h2>
      <p className="text-xl text-[#555555] mb-12 max-w-3xl mx-auto leading-relaxed">
