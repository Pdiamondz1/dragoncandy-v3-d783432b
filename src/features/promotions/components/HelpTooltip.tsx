  ...
  return (
    <span className="relative inline-flex items-center">
      <button
        ...
        aria-label="Help"
        className="w-5 h-5 rounded-full bg-dc-teal-btn text-white flex items-center justify-center text-[11px] font-bold hover:bg-dc-teal/80 transition-colors focus:outline-none focus:ring-2 focus:ring-dc-teal/40 focus:ring-offset-1"
      >
