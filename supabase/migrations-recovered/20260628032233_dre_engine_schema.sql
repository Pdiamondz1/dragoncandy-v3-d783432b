...
-- place this migration existed. Version 20260628032233 IS recorded on production.
...
-- 7. Seed config (point values + tier thresholds + go-live cutover).
insert into public.dre_config (config_key, config_value) values
  ...
  ('go_live_at', '"2099-01-01T00:00:00Z"'::jsonb)
