-- Fix phantom message notification badge: exclude conversations with zero messages
-- from Branch 1 (direct conversations). Branch 2 (campaign conversations) already
-- has an EXISTS guard.
