...
-- Billing (3)
('pricing-tiers', 'Pricing tiers explained', 'DragonCandy offers four tiers: Free, Starter ($199/mo), Growth ($499/mo), and Pro ($999/mo). Free includes 1 active campaign, brief generation, and campaign templates. Starter adds creator delivery and basic analytics. Growth adds DragonDash, advanced analytics, and multi-unit management. Pro adds API access, custom branding, and priority support. Enterprise pricing is available on request.', 'billing', '{restaurant,brand}', '{pricing,tiers,plans,cost,free,starter,growth,pro,enterprise}'),
