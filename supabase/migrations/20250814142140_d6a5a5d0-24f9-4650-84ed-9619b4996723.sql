-- Update get_user_conversations function to fall back to email when full_name is null
...
BEGIN
  ...
  SELECT 
    ...
    -- For direct conversations, get the other participant's name with email fallback
